...
public interface StudentSubjectMapper {
    ...
    @Mapping(source = "studentSubject.subject.id", target = "subject.id")
    @Mapping(source = "studentSubject.subject.name", target = "subject.name")
    @Mapping(source = "studentSubject.subject.description", target = "subject.description")
